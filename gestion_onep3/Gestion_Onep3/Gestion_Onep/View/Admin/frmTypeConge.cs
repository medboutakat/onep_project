...
{
    public partial class frmTypeConge : Form
    {
        bool NewObject = false;
        Gestion_Onep.MODEL.typeconge curentObject;
        public frmTypeConge()
        {
            InitializeComponent();
            ...
            dataGridView1.SelectionChanged += (e,ee) =>
            {
                ...
                {
                    curentObject = (dataGridView1.SelectedRows[0].DataBoundItem as MODEL.typeconge);
        ...
        {
            dataGridView1.DataSource = BL.TypeCongeBL.Instance.GetAll();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (curentObject != null)
                {
                    ...
                    if (NewObject)
                    {
                        BL.TypeCongeBL.Instance.Add(curentObject);
                    }
                    else
                    {
                        BL.TypeCongeBL.Instance.Update(curentObject);
                    }
        ...
        { 
            ...
            curentObject = new  MODEL.typeconge();
